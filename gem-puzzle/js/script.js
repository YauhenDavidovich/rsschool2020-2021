...
function greeting() {
  ...
  modalGreeting.innerHTML = `<div class="button__new greeting__button">New Game</div>
  <div class="button__load greeting__button">Load Game</div><div class="button__score greeting__button">Score</div>`;
  board.append(modalGreeting);
}

window.addEventListener('DOMContentLoaded', createBoard(4), greeting());
